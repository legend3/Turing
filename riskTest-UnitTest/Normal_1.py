        ...
        try:
            ...
            try:
                    # try:
                        ...
                        # size = self.userQueue.size()

                        time_list = self.dateList
                        ...
                        for t_e in self.dateList:
                            ...
                            if xinqi == 6 or xinqi == 0:
                                user_n_weekend = xinqi % 2+1
                                api_num = sam_simple_po(1, -1, 1, 3, 2)[0]
                                user_list_now = RandomSampling(user_list_ana, user_n_weekend)


                            else:
                                api_num = sam_simple_po(1, 2.6, 0.4, api_top_num, 1)[0]

                                user_list_now = RandomSampling(user_list_ana, 12)
                            ip_ne += 1
                            aaa = 0
                            ...
                            for ur in user_list_now:
                                ...
                                api_list_now = RandomSampling(self.apiList, api_num)
                                ...
                                for api in api_list_now:
                                    ...
                                    if batch_time:
                                        ...
                                        for j in xrange(len(batch_time)):
                                            ...
                                            batch_long = sam_simple_po(1, 11, 6, 22, 2)[0]
                                            # print batch_long
