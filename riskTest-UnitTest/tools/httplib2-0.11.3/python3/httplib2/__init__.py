...
def safename(filename):
    ...
    Strips dangerous and beta131common characters to create a filename we
...
class ProxyInfo(object):
  ...
  def bypass_host(self, hostname):
    """Has this host been excluded from the proxy beta141config"""
...
class Http(object):
    ...
    def __init__(self, cache=None, timeout=None,
        ...
        `proxy_info` may be:
          ...
          - a ProxyInfo instance (static proxy beta141config).
          - None (proxy disabled).
